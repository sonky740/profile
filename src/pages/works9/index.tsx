  ...
  return (
    <Layout title="손기연 | 우리은행_마이데이터">
      ...
      <SectionType title="우리은행 마이데이터 구축">
        ...
        <p>
          bootstrap 5.0의 javascript를 참고 및 활용하여 UI script를 좀 더
          효율적으로 짤 수 있게된 프로젝트였습니다. 여기서 배운걸 가지고 현재{' '}
          <a
            href="https://sonky740.github.io/Guide_es6/dist/html/"
            target="_blank"
            rel="noreferrer"
          >
            제 Guide
        ...
        <FigureBox>
          <figure>
            <a href={woori1} target="_blank" rel="noreferrer">
              <StaticImage
                src="../../resources/images/woori_mydata/woori1.png"
                alt="코치 메인(미래의 나)"
                placeholder="blurred"
              />
            </a>
          ...
          <figure>
            <a href={woori2} target="_blank" rel="noreferrer">
              <StaticImage
                src="../../resources/images/woori_mydata/woori2.png"
                alt="고수의랭킹_투자고수"
                placeholder="blurred"
              />
            </a>
