        ...
        <FigureBox>
          <figure>
            <a href={Jamo1} target="_blank" rel="noreferrer">
              <StaticImage src="../../resources/images/jamo/jamo1.png" alt="자모 메인" />
            </a>
            <figcaption>메인 페이지</figcaption>
          </figure>
          <figure>
            <a href={Jamo2} target="_blank" rel="noreferrer">
              <StaticImage src="../../resources/images/jamo/jamo2.png" alt="자모 네비게이션" />
            </a>
            <figcaption>네비게이션을 열었을 때</figcaption>
          </figure>
          <figure>
            <a href={Jamo3} target="_blank" rel="noreferrer">
              <StaticImage src="../../resources/images/jamo/jamo3.png" alt="자모 콘텐츠 교정" />
            </a>
