...
const IndexPage = () => {
  ...
  const list2: Array<listType> = [
    ...
    {
      content:
        '이전 작업자가 탭 형식으로 작업하여 URL 구분이 안되어 GA 트래킹을 위한 react-router-dom의 hooks을 활용한 URL 구분',
    },
  ];
        ...
        <FigureBox>
          <figure>
            <a href={apt_mobile} target="_blank" rel="noreferrer">
              <StaticImage
                src="../../resources/images/apt/aptcare_mobile.png"
                alt="아파트청약케어 앱 메인"
                placeholder="blurred"
              />
            </a>
          ...
          <figure>
            <a href={apt_pc} target="_blank" rel="noreferrer">
              <StaticImage
                src="../../resources/images/apt/aptcare_pc.png"
                alt="아파트청약케어 앱 메인"
                placeholder="blurred"
              />
            </a>
