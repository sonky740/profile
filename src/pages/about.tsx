        ...
        <About>
          ...
          <Dl title="이 사이트는 어떤 구조로 되어있나?">
            <p>
              ...
              프레임워크를 기반으로 <a href="https://www.typescriptlang.org/ko/docs/handbook/react.html" target="_blank" className="link" rel="noreferrer">TypeScript(tsx)</a>로 구축하였습니다.
            </p>
            <p>
          ...
          <Dl title="왜 GatsbyJS를 썼는지?">
            ...
            <p>2-2. 이미지 로드 성능을 높이기위한 <a href="https://www.gatsbyjs.com/plugins/gatsby-plugin-image/" target="_blank" rel="noreferrer" className="link">gaysby-plugin-image</a>, Link에 마우스를 올리기만해도 해당 Link를 미리 불러와서 빠른 로딩을 구현하는게 간단하였습니다.</p>
          </Dl>
        </About>
      </SectionMain>
    </Layout>
