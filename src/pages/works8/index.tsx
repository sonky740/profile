        ...
        <FigureBox>
          <figure>
            <a href={KbOpenbk1} target="_blank" rel="noreferrer">
              <StaticImage src="../../resources/images/kbopenbk/kb_openbk1.png" alt="인터넷뱅킹 입출금 현황 퍼블 페이지" />
            </a>
            <figcaption>인터넷뱅킹 입출금 현황 퍼블 페이지</figcaption>
          </figure>
          <figure>
            <a href={KbOpenbk2} target="_blank" rel="noreferrer">
              <StaticImage src="../../resources/images/kbopenbk/kb_openbk2.png" alt="인터넷뱅킹 자산현황 퍼블 페이지" />
            </a>
            <figcaption>
              인터넷뱅킹 자산현황 퍼블 페이지 (
              <a href="http://demo.riamore.net/HTML5demo/chart/" target="_blank" rel="noreferrer">
                rMate 차트
              </a>{' '}
              활용)
            </figcaption>
